...
public class FillScreen : MonoBehaviour {
	...
	void LateUpdate () {
        ...
        portal1Cam.transform.rotation = cam.transform.rotation;
        portal2Cam.transform.rotation = cam.transform.rotation;
...
/*		Quaternion q = Quaternion.FromToRotation(-portal1.up, cam.transform.forward);
        ...
        portal1Cam.fieldOfView = cam.fieldOfView - Mathf.Abs((portal1Cam.transform.position - cam.transform.position).magnitude) + 60;
...
/*		q = Quaternion.FromToRotation(-portal2.up, cam.transform.forward);
		...
		portal2Cam.fieldOfView = cam.fieldOfView - Mathf.Abs((portal2Cam.transform.position - cam.transform.position).magnitude) + 60;
